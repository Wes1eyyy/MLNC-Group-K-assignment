...
# Helper: combine a home-column and away-column into team totals
...
# ---- Recent-period win rate (2021-08-13 to 2024-05-19) ----
start_recent = pd.Timestamp("2021-08-13")
end_recent = pd.Timestamp("2024-05-19")
...
features["Recent_Matches"] = recent_matches.reindex(teams).astype(int)
features["Recent_Wins"] = recent_stats["Recent_Wins"].reindex(teams).astype(int)
