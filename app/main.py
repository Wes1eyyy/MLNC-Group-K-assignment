...
print(f"Home team record: {sample_match['HomeTeam_Wins']}W-{sample_match['HomeTeam_Draws']}D-{sample_match['HomeTeam_Losses']}L")
print(f"Away team record: {sample_match['AwayTeam_Wins']}W-{sample_match['AwayTeam_Draws']}D-{sample_match['AwayTeam_Losses']}L")
print(f"Result: {sample_match['FTR']}")
